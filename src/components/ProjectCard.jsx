            ...
            <div className="flex flex-row p-1 transition duration-500 ease-in-out transform bg-white border-2 border-blue-500 hover:shadow-md hover:-translate-y-2 hover:border-opacity-100 hover:z-10">
                ...
                <div className="relative flex flex-col justify-center flex-1 w-3/5 p-4 xl:h-44">
                    ...
                    <div className="absolute bottom-0 flex flex-row flex-wrap -mt-1 space-x-4">
                        {project.link && (
                            <a href={project.link} className="inline-flex items-center w-6 h-6 mb-2 text-sm font-normal leading-none text-blue-300 transition duration-500 ease-in-out transform hover:text-blue-500">
                        ...
                        {project.github && (
                            <a href={project.github} className="inline-flex items-center w-6 h-6 mb-2 text-sm font-normal leading-none text-blue-300 transition duration-500 ease-in-out transform hover:text-blue-500">
